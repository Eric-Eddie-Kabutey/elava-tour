        ...
        <section className='tour-bg w-full h-[500px] flex flex-col gap-3 overflow-visible'>
            <div className='xl:w-[85%] w-[90%] pt-32 max-container mx-auto flex flex-col gap-6 text-white'>
                ...
                >Belize tour photos from our travellers</Typography>
                 <div className='w-full p-6 md:columns-5 sm:columns-4 columns-3 gap-4 bg-white rounded-md min-h-[484px]'>
                    {tourImages.length > 0 ? tourImages.map((image, index) => (
                    ...
                    )) : <div className='col-span-5 w-full outline'>
                              <p className='text-lg text-black font-semibold'>No Tour&apos;s Photo.</p>
                    </div>
                      }
                </div>
            </div>
