  ...
  return (
    <div className='w-full py-20 bg-gradient-to-br from-gray-50 to-gray-100'>
        <section className='max-container w-[85%] mx-auto flex flex-col gap-16'>
            ...
            <div className="w-full py-12 px-16 flex flex-col gap-6 bg-white">
                <Typography
                ...
                <div className='w-full grid grid-cols-1 lg:grid-cols-2 gap-16 '>
                    {contact_details.map((member, index) => (
                        <div 
                            key={index}
                            className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl border border-gray-100 w-full"
                        >
