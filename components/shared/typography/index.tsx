...
const typoVariants = cva("overflow-wrap overflow-hidden leading-normal", {
  variants: {
    typo: {
      ...
      "header-4-light": "lg:text-[31px] sm:text-[28px] xs:text-[25px] text-[18px] leading-[40px] font-extralight",
      ...
      "header-4-semibold": "lg:text-[31px] sm:text-[28px] xs:text-[25px] text-[18px] lg:leading-[40px] xs:leading-[37px] leading-[25px] font-semibold",
      "header-4-bold": "lg:text-[31px] sm:text-[28px] xs:text-[25px] text-[18px] lg:leading-[40px] leading-[37px] font-bold",
      ...
      "body-large-light": "xl:text-[18px] md:text-[15px] sm:text-[14px] text-[16px] leading-normal font-light",
      "body-large-regular": "xl:text-[18px] md:text-[15px] sm:text-[14px] text-[16px] leading-normal font-normal",
      "body-large-medium": "xl:text-[18px] md:text-[15px] sm:text-[14px] text-[16px] leading-normal font-medium",
      "body-large-semibold": "xl:text-[18px] md:text-[15px] sm:text-[14px] text-[16px] leading-normal font-semibold",
      "body-large-underline": "",
      "body-medium-light": "sm:text-[16px] text-[15px] leading-[24px] font-light",
      "body-medium-regular": "sm:text-[16px] text-[15px] leading-[24px] font-normal",
      "body-medium-medium": "sm:text-[16px] text-[15px] leading-[24px] font-medium",
      ...
      "body-small-light": "text-[13px] leading-[16px] font-light",
